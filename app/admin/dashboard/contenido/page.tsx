...
> = {
  home: [
    ...
    { key: "intro_title", label: "\"Deja la ciudad atrás\": título" },
    { key: "intro_text", label: "\"Deja la ciudad atrás\": texto", textarea: true },
    { key: "location_title", label: "Ubicación: título" },
    { key: "location_text", label: "Ubicación: texto", textarea: true },
    { key: "experience_title", label: "El Campo: título" },
    { key: "experience_text", label: "El Campo: texto", textarea: true },
    { key: "game_title", label: "El Juego: título" },
    { key: "game_text", label: "El Juego: texto", textarea: true },
    { key: "community_title", label: "Comunidad: título" },
    { key: "community_text", label: "Comunidad: texto", textarea: true },
    { key: "history_title", label: "Historia: título" },
    { key: "history_text", label: "Historia: texto", textarea: true },
    { key: "club_title", label: "El Club (teaser): título" },
    { key: "club_text", label: "El Club (teaser): texto", textarea: true },
